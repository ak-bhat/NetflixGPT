...
const Header = () => {
  ...
  return (
    <div className="absolute flex w-full justify-between px-8 py-2 bg-gradient-to-b from-black z-30">
      ...
      {user && (
        <div className="flex p-4 ">
          ...
          <img className="hidden md:block w-10 h-10 m-2" src={user.photoURL} alt="ProPic" />
